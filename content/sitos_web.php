<div class="container">
    ...
    <div class="row content-titulo">
        <div class="col-12">
            <img src="../imagen/sitios_web/Grupo_96.png" alt="">
        </div>
    </div>
    <!-- <div class="row content-titulo">
        <div class="col-12 content-img">
            <img src="../imagen/nasbi/post_1.png" class="img-centro" alt="">
            <img src="../imagen/nasbi/TyC-01.png" class="img-centro" alt="">
        </div>
    </div>
    <div class="row content-titulo">
        <div class="col-12">
            <img src="../imagen/nasbi/Banner.png" alt="">
        </div>
    </div> -->
</div>
